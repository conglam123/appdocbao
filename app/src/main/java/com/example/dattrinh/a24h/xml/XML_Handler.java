    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        switch (qName) {
            ...
            case TITLE:
                ...
                break;
            case DESCRIPTION:
                String description = builder.substring(builder.indexOf("src = '") + 1);
                String img1 = "src=";
                String img2 = builder.toString();
                img2 = img2.substring(img2.indexOf(img1)+img1.length() + 3);
                Log.e("test",img2);
                String img = "ht" + img2.substring(0, img2.indexOf("/></a>") - 2);
                Log.e("link img", img);
                description = description.substring(description.indexOf("/></a>") + 6);
